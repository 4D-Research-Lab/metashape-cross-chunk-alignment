  ...
  Developed by Aaricia Kuiters, based on [agisoft-llc/metashape-scripts](https://github.com/agisoft-llc/metashape-scripts) `align_model_to_model.py`, adapted for cross-chunk alignment. Aaricia's original (pre-fix) script is in `reference/align_chunk_to_model.py`.
